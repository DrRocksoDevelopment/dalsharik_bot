...
3. Даётся 4 варианта ответа (answers), из них ровно один верный — у него "correct": true.
...
- answers: минимум 4 объекта {text, correct}; ровно у одного correct = true, у остальных false.
...
- correct: true отсутствует среди вариантов.
- верных вариантов не ровно один.
